...
import "lacrypta-gateway/contracts/Strings.sol"; 

import {IPeronio, PeQuantity, UsdcQuantity} from "peronio-core/contracts/IPeronio.sol";

import {IPeronioGateway} from "./IPeronioGateway.sol";

contract PeronioGateway is IPeronioGateway, ERC20PermitGateway {
